 ...
 */
extern void mul_array16(int32_t *a, uint32_t n, const uint16_t *p);
 ...
 */
extern void mul_array(int32_t *c, uint32_t n, const int32_t *a, const int32_t *b);
 ...
 */
extern void scalar_mul_array(int32_t *a, uint32_t n, int32_t c);
 ...
 */
extern void ntt_ct_rev2std_v1(int32_t *a, uint32_t n, const uint16_t *p);
 ...
 * - output: a contains the NTT(a) in standard order
 */
extern void ntt_ct_rev2std(int32_t *a, uint32_t n, const uint16_t *p);
 ...
 */
extern void mulntt_ct_rev2std(int32_t *a, uint32_t n, const uint16_t *p);
 ...
 */
extern void ntt_ct_std2rev(int32_t *a, uint32_t n, const uint16_t *p);
 ...
 */
extern void mulntt_ct_std2rev(int32_t *a, uint32_t n, const uint16_t *p);
 ...
 */
extern void ntt_gs_rev2std(int32_t *a, uint32_t n, const uint16_t *p);
 ...
 */
extern void nttmul_gs_rev2std(int32_t *a, uint32_t n, const uint16_t *p);
 ...
 */
extern void ntt_gs_std2rev(int32_t *a, uint32_t n, const uint16_t *p);
 ...
 */
extern void nttmul_gs_std2rev(int32_t *a, uint32_t n, const uint16_t *p);
