...
int main(void){
  ...
  printf("Testing ntt_red1024_product1 (KAT values)\n");
  test_mul_from_KAT_values(ntt_red1024_product1);

  printf("\nTesting ntt_red1024_product2 (KAT values)\n");
  test_mul_from_KAT_values(ntt_red1024_product2);

  printf("\nTesting ntt_red1024_product3 (KAT values)\n");
  test_mul_from_KAT_values(ntt_red1024_product3);

  printf("\nTesting ntt_red1024_product4 (KAT values)\n");
  test_mul_from_KAT_values(ntt_red1024_product4);

  printf("\nTesting ntt_red1024_product5 (KAT values)\n");
  test_mul_from_KAT_values(ntt_red1024_product5);
