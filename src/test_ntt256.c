...
static void check_inverse(const char *fname, const char *iname, 
  ...
  scalar_mul_array(b, 256, ntt256_inv_n); // divide by n
...
int main(void) {
  test_simple_polys("ntt256_ct_rev2std", ntt256_ct_rev2std, ntt256_omega, false);
  test_simple_polys("ntt256_gs_rev2std", ntt256_gs_rev2std, ntt256_omega, false);
  test_simple_polys("ntt256_ct_std2rev", ntt256_ct_std2rev, ntt256_omega, true);
  test_simple_polys("ntt256_gs_std2rev", ntt256_gs_std2rev, ntt256_omega, true);

  test_simple_polys("intt256_ct_rev2std", intt256_ct_rev2std, ntt256_inv_omega, false);
  test_simple_polys("intt256_gs_rev2std", intt256_gs_rev2std, ntt256_inv_omega, false);
  test_simple_polys("intt256_ct_std2rev", intt256_ct_std2rev, ntt256_inv_omega, true);
  test_simple_polys("intt256_gs_std2rev", intt256_gs_std2rev, ntt256_inv_omega, true);

  test_forward_inverse("ntt256_ct_std2rev", "intt256_ct_rev2std", ntt256_ct_std2rev, intt256_ct_rev2std);
  test_forward_inverse("intt256_ct_rev2std", "ntt256_ct_std2rev", intt256_ct_rev2std, ntt256_ct_std2rev);
  test_forward_inverse("ntt256_ct_std2rev", "intt256_gs_rev2std", ntt256_ct_std2rev, intt256_gs_rev2std);
  test_forward_inverse("intt256_gs_rev2std", "ntt256_ct_std2rev", intt256_gs_rev2std, ntt256_ct_std2rev);
  test_forward_inverse("ntt256_gs_std2rev", "intt256_gs_rev2std", ntt256_gs_std2rev, intt256_gs_rev2std);
  test_forward_inverse("intt256_gs_rev2std", "ntt256_gs_std2rev", intt256_gs_rev2std, ntt256_gs_std2rev);

  test_simple_products("ntt256_product1", ntt256_product1);
  test_simple_products("ntt256_product2", ntt256_product2);
  test_simple_products("ntt256_product3", ntt256_product3);
  test_simple_products("ntt256_product4", ntt256_product4);
  test_simple_products("ntt256_product5", ntt256_product5);
  
  speed_test("ntt256_ct_rev2std", ntt256_ct_rev2std);
  speed_test("ntt256_gs_rev2std", ntt256_gs_rev2std);
  speed_test("ntt256_ct_std2rev", ntt256_ct_std2rev);
  speed_test("ntt256_gs_std2rev", ntt256_gs_std2rev);
  printf("\n");
  speed_test("intt256_ct_rev2std", intt256_ct_rev2std);
  speed_test("intt256_gs_rev2std", intt256_gs_rev2std);
  speed_test("intt256_ct_std2rev", intt256_ct_std2rev);
  speed_test("intt256_gs_std2rev", intt256_gs_std2rev);
  printf("\n");

  speed_test2("ntt256_product1", ntt256_product1);
  speed_test2("ntt256_product2", ntt256_product2);
  speed_test2("ntt256_product3", ntt256_product3);
  speed_test2("ntt256_product4", ntt256_product4);
  speed_test2("ntt256_product5", ntt256_product5);
