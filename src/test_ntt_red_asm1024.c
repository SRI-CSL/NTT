...
static void check_inverse(const char *fname, const char *iname, 
  ...
  normalize(b, 1024);
  scalar_mul_array(b, 1024, ntt_red1024_inv_n); // divide by n
...
int main(void) {
  ...
  test_simple_polys("ntt_red1024_ct_rev2std_asm", ntt_red1024_ct_rev2std_asm, ntt_red1024_omega, false);
  test_simple_polys("ntt_red1024_gs_rev2std_asm", ntt_red1024_gs_rev2std_asm, ntt_red1024_omega, false);
  test_simple_polys("ntt_red1024_ct_std2rev_asm", ntt_red1024_ct_std2rev_asm, ntt_red1024_omega, true);
  test_simple_polys("ntt_red1024_gs_std2rev_asm", ntt_red1024_gs_std2rev_asm, ntt_red1024_omega, true);

  test_simple_polys("intt_red1024_ct_rev2std_asm", intt_red1024_ct_rev2std_asm, ntt_red1024_inv_omega, false);
  test_simple_polys("intt_red1024_gs_rev2std_asm", intt_red1024_gs_rev2std_asm, ntt_red1024_inv_omega, false);
  test_simple_polys("intt_red1024_ct_std2rev_asm", intt_red1024_ct_std2rev_asm, ntt_red1024_inv_omega, true);
  test_simple_polys("intt_red1024_gs_std2rev_asm", intt_red1024_gs_std2rev_asm, ntt_red1024_inv_omega, true);

  test_forward_inverse("ntt_red1024_ct_std2rev_asm", "intt_red1024_ct_rev2std_asm", ntt_red1024_ct_std2rev_asm, intt_red1024_ct_rev2std_asm);
  test_forward_inverse("intt_red1024_ct_rev2std_asm", "ntt_red1024_ct_std2rev_asm", intt_red1024_ct_rev2std_asm, ntt_red1024_ct_std2rev_asm);
  test_forward_inverse("ntt_red1024_ct_std2rev_asm", "intt_red1024_gs_rev2std_asm", ntt_red1024_ct_std2rev_asm, intt_red1024_gs_rev2std_asm);
  test_forward_inverse("intt_red1024_gs_rev2std_asm", "ntt_red1024_ct_std2rev_asm", intt_red1024_gs_rev2std_asm, ntt_red1024_ct_std2rev_asm);
  test_forward_inverse("ntt_red1024_gs_std2rev_asm", "intt_red1024_gs_rev2std_asm", ntt_red1024_gs_std2rev_asm, intt_red1024_gs_rev2std_asm);
  test_forward_inverse("intt_red1024_gs_rev2std_asm", "ntt_red1024_gs_std2rev_asm", intt_red1024_gs_rev2std_asm, ntt_red1024_gs_std2rev_asm);

  test_simple_products("ntt_red1024_product1_asm", ntt_red1024_product1_asm);
  test_simple_products("ntt_red1024_product2_asm", ntt_red1024_product2_asm);
  test_simple_products("ntt_red1024_product3_asm", ntt_red1024_product3_asm);
  test_simple_products("ntt_red1024_product4_asm", ntt_red1024_product4_asm);
  test_simple_products("ntt_red1024_product5_asm", ntt_red1024_product5_asm);

  speed_test("ntt_red1024_ct_rev2std_asm", ntt_red1024_ct_rev2std_asm);
  speed_test("ntt_red1024_gs_rev2std_asm", ntt_red1024_gs_rev2std_asm);
  speed_test("ntt_red1024_ct_std2rev_asm", ntt_red1024_ct_std2rev_asm);
  speed_test("ntt_red1024_gs_std2rev_asm", ntt_red1024_gs_std2rev_asm);
  printf("\n");
  speed_test("intt_red1024_ct_rev2std_asm", intt_red1024_ct_rev2std_asm);
  speed_test("intt_red1024_gs_rev2std_asm", intt_red1024_gs_rev2std_asm);
  speed_test("intt_red1024_ct_std2rev_asm", intt_red1024_ct_std2rev_asm);
  speed_test("intt_red1024_gs_std2rev_asm", intt_red1024_gs_std2rev_asm);
  printf("\n");

  speed_test2("ntt_red1024_product1_asm", ntt_red1024_product1_asm);
  speed_test2("ntt_red1024_product2_asm", ntt_red1024_product2_asm);
  speed_test2("ntt_red1024_product3_asm", ntt_red1024_product3_asm);
  speed_test2("ntt_red1024_product4_asm", ntt_red1024_product4_asm);
  speed_test2("ntt_red1024_product5_asm", ntt_red1024_product5_asm);
