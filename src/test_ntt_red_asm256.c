...
static void check_inverse(const char *fname, const char *iname, 
  ...
  normalize(b, 256);
  scalar_mul_array(b, 256, ntt_red256_inv_n); // divide by n
...
int main(void) {
  ...
  test_simple_polys("ntt_red256_gs_std2rev_asm", ntt_red256_gs_std2rev_asm, ntt_red256_omega, true);

  test_simple_polys("intt_red256_ct_rev2std_asm", intt_red256_ct_rev2std_asm, ntt_red256_inv_omega, false);
  test_simple_polys("intt_red256_gs_rev2std_asm", intt_red256_gs_rev2std_asm, ntt_red256_inv_omega, false);
  test_simple_polys("intt_red256_ct_std2rev_asm", intt_red256_ct_std2rev_asm, ntt_red256_inv_omega, true);
  test_simple_polys("intt_red256_gs_std2rev_asm", intt_red256_gs_std2rev_asm, ntt_red256_inv_omega, true);

  test_forward_inverse("ntt_red256_ct_std2rev_asm", "intt_red256_ct_rev2std_asm", ntt_red256_ct_std2rev_asm, intt_red256_ct_rev2std_asm);
  test_forward_inverse("intt_red256_ct_rev2std_asm", "ntt_red256_ct_std2rev_asm", intt_red256_ct_rev2std_asm, ntt_red256_ct_std2rev_asm);
  test_forward_inverse("ntt_red256_ct_std2rev_asm", "intt_red256_gs_rev2std_asm", ntt_red256_ct_std2rev_asm, intt_red256_gs_rev2std_asm);
  test_forward_inverse("intt_red256_gs_rev2std_asm", "ntt_red256_ct_std2rev_asm", intt_red256_gs_rev2std_asm, ntt_red256_ct_std2rev_asm);
  test_forward_inverse("ntt_red256_gs_std2rev_asm", "intt_red256_gs_rev2std_asm", ntt_red256_gs_std2rev_asm, intt_red256_gs_rev2std_asm);
  test_forward_inverse("intt_red256_gs_rev2std_asm", "ntt_red256_gs_std2rev_asm", intt_red256_gs_rev2std_asm, ntt_red256_gs_std2rev_asm);

  test_simple_products("ntt_red256_product1_asm", ntt_red256_product1_asm);
  test_simple_products("ntt_red256_product2_asm", ntt_red256_product2_asm);
  test_simple_products("ntt_red256_product3_asm", ntt_red256_product3_asm);
  test_simple_products("ntt_red256_product4_asm", ntt_red256_product4_asm);
  test_simple_products("ntt_red256_product5_asm", ntt_red256_product5_asm);

  speed_test("ntt_red256_ct_rev2std_asm", ntt_red256_ct_rev2std_asm);
  speed_test("ntt_red256_gs_rev2std_asm", ntt_red256_gs_rev2std_asm);
  speed_test("ntt_red256_ct_std2rev_asm", ntt_red256_ct_std2rev_asm);
  speed_test("ntt_red256_gs_std2rev_asm", ntt_red256_gs_std2rev_asm);
  printf("\n");
  speed_test("intt_red256_ct_rev2std_asm", intt_red256_ct_rev2std_asm);
  speed_test("intt_red256_gs_rev2std_asm", intt_red256_gs_rev2std_asm);
  speed_test("intt_red256_ct_std2rev_asm", intt_red256_ct_std2rev_asm);
  speed_test("intt_red256_gs_std2rev_asm", intt_red256_gs_std2rev_asm);
  printf("\n");

  speed_test2("ntt_red256_product1_asm", ntt_red256_product1_asm);
  speed_test2("ntt_red256_product2_asm", ntt_red256_product2_asm);
  speed_test2("ntt_red256_product3_asm", ntt_red256_product3_asm);
  speed_test2("ntt_red256_product4_asm", ntt_red256_product4_asm);
  speed_test2("ntt_red256_product5_asm", ntt_red256_product5_asm);
