 ...
 */
static void ntt1024_normalize(int32_t *a, uint32_t n) {
  uint32_t i;
...
static void check_inverse(const char *fname, const char *iname, 
  ...
  scalar_mul_array_naive(b, 1024, ntt1024_inv_n, 12289); // divide by n
  ntt1024_normalize(b, 1024);
...
int main(void) {
  test_simple_polys("naive_ntt1024_ct_rev2std", naive_ntt1024_ct_rev2std, ntt1024_omega, false);
  test_simple_polys("naive_ntt1024_gs_rev2std", naive_ntt1024_gs_rev2std, ntt1024_omega, false);
  test_simple_polys("naive_ntt1024_ct_std2rev", naive_ntt1024_ct_std2rev, ntt1024_omega, true);
  test_simple_polys("naive_ntt1024_gs_std2rev", naive_ntt1024_gs_std2rev, ntt1024_omega, true);

  test_simple_polys("naive_intt1024_ct_rev2std", naive_intt1024_ct_rev2std, ntt1024_inv_omega, false);
  test_simple_polys("naive_intt1024_gs_rev2std", naive_intt1024_gs_rev2std, ntt1024_inv_omega, false);
  test_simple_polys("naive_intt1024_ct_std2rev", naive_intt1024_ct_std2rev, ntt1024_inv_omega, true);
  test_simple_polys("naive_intt1024_gs_std2rev", naive_intt1024_gs_std2rev, ntt1024_inv_omega, true);

  test_forward_inverse("naive_ntt1024_ct_std2rev", "naive_intt1024_ct_rev2std", naive_ntt1024_ct_std2rev, naive_intt1024_ct_rev2std);
  test_forward_inverse("naive_intt1024_ct_rev2std", "naive_ntt1024_ct_std2rev", naive_intt1024_ct_rev2std, naive_ntt1024_ct_std2rev);
  test_forward_inverse("naive_ntt1024_ct_std2rev", "naive_intt1024_gs_rev2std", naive_ntt1024_ct_std2rev, naive_intt1024_gs_rev2std);
  test_forward_inverse("naive_intt1024_gs_rev2std", "naive_ntt1024_ct_std2rev", naive_intt1024_gs_rev2std, naive_ntt1024_ct_std2rev);
  test_forward_inverse("naive_ntt1024_gs_std2rev", "naive_intt1024_gs_rev2std", naive_ntt1024_gs_std2rev, naive_intt1024_gs_rev2std);
  test_forward_inverse("naive_intt1024_gs_rev2std", "naive_ntt1024_gs_std2rev", naive_intt1024_gs_rev2std, naive_ntt1024_gs_std2rev);

  test_simple_products("naive_ntt1024_product1", naive_ntt1024_product1);
  test_simple_products("naive_ntt1024_product2", naive_ntt1024_product2);
  test_simple_products("naive_ntt1024_product3", naive_ntt1024_product3);
  test_simple_products("naive_ntt1024_product4", naive_ntt1024_product4);
  test_simple_products("naive_ntt1024_product5", naive_ntt1024_product5);
  
  speed_test("naive_ntt1024_ct_rev2std", naive_ntt1024_ct_rev2std);
  speed_test("naive_ntt1024_gs_rev2std", naive_ntt1024_gs_rev2std);
  speed_test("naive_ntt1024_ct_std2rev", naive_ntt1024_ct_std2rev);
  speed_test("naive_ntt1024_gs_std2rev", naive_ntt1024_gs_std2rev);
  printf("\n");
  speed_test("naive_intt1024_ct_rev2std", naive_intt1024_ct_rev2std);
  speed_test("naive_intt1024_gs_rev2std", naive_intt1024_gs_rev2std);
  speed_test("naive_intt1024_ct_std2rev", naive_intt1024_ct_std2rev);
  speed_test("naive_intt1024_gs_std2rev", naive_intt1024_gs_std2rev);
  printf("\n");

  speed_test2("naive_ntt1024_product1", naive_ntt1024_product1);
  speed_test2("naive_ntt1024_product2", naive_ntt1024_product2);
  speed_test2("naive_ntt1024_product3", naive_ntt1024_product3);
  speed_test2("naive_ntt1024_product4", naive_ntt1024_product4);
  speed_test2("naive_ntt1024_product5", naive_ntt1024_product5);
