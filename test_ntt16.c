...
static void check_inverse(const char *fname, const char *iname, 
  ...
  scalar_mul_array(b, 16, ntt16_inv_n); // divide by n
...
int main(void) {
  test_simple_polys("ntt16_ct_rev2std", ntt16_ct_rev2std, ntt16_omega, false);
  test_simple_polys("ntt16_gs_rev2std", ntt16_gs_rev2std, ntt16_omega, false);
  test_simple_polys("ntt16_ct_std2rev", ntt16_ct_std2rev, ntt16_omega, true);
  test_simple_polys("ntt16_gs_std2rev", ntt16_gs_std2rev, ntt16_omega, true);

  test_simple_polys("intt16_ct_rev2std", intt16_ct_rev2std, ntt16_inv_omega, false);
  test_simple_polys("intt16_gs_rev2std", intt16_gs_rev2std, ntt16_inv_omega, false);
  test_simple_polys("intt16_ct_std2rev", intt16_ct_std2rev, ntt16_inv_omega, true);
  test_simple_polys("intt16_gs_std2rev", intt16_gs_std2rev, ntt16_inv_omega, true);

  test_forward_inverse("ntt16_ct_std2rev", "intt16_ct_rev2std", ntt16_ct_std2rev, intt16_ct_rev2std);
  test_forward_inverse("intt16_ct_rev2std", "ntt16_ct_std2rev", intt16_ct_rev2std, ntt16_ct_std2rev);
  test_forward_inverse("ntt16_ct_std2rev", "intt16_gs_rev2std", ntt16_ct_std2rev, intt16_gs_rev2std);
  test_forward_inverse("intt16_gs_rev2std", "ntt16_ct_std2rev", intt16_gs_rev2std, ntt16_ct_std2rev);
  test_forward_inverse("ntt16_gs_std2rev", "intt16_gs_rev2std", ntt16_gs_std2rev, intt16_gs_rev2std);
  test_forward_inverse("intt16_gs_rev2std", "ntt16_gs_std2rev", intt16_gs_rev2std, ntt16_gs_std2rev);

  test_simple_products("ntt16_product1", ntt16_product1);
  test_simple_products("ntt16_product2", ntt16_product2);
  test_simple_products("ntt16_product3", ntt16_product3);
  test_simple_products("ntt16_product4", ntt16_product4);
  test_simple_products("ntt16_product5", ntt16_product5);
  
  speed_test("ntt16_ct_rev2std", ntt16_ct_rev2std);
  speed_test("ntt16_gs_rev2std", ntt16_gs_rev2std);
  speed_test("ntt16_ct_std2rev", ntt16_ct_std2rev);
  speed_test("ntt16_gs_std2rev", ntt16_gs_std2rev);
  printf("\n");
  speed_test("intt16_ct_rev2std", intt16_ct_rev2std);
  speed_test("intt16_gs_rev2std", intt16_gs_rev2std);
  speed_test("intt16_ct_std2rev", intt16_ct_std2rev);
  speed_test("intt16_gs_std2rev", intt16_gs_std2rev);
  printf("\n");

  speed_test2("ntt16_product1", ntt16_product1);
  speed_test2("ntt16_product2", ntt16_product2);
  speed_test2("ntt16_product3", ntt16_product3);
  speed_test2("ntt16_product4", ntt16_product4);
  speed_test2("ntt16_product5", ntt16_product5);
