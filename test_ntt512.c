...
static void check_inverse(const char *fname, const char *iname, 
  ...
  scalar_mul_array(b, 512, ntt512_inv_n); // divide by n
...
int main(void) {
  test_simple_polys("ntt512_ct_rev2std", ntt512_ct_rev2std, ntt512_omega, false);
  test_simple_polys("ntt512_gs_rev2std", ntt512_gs_rev2std, ntt512_omega, false);
  test_simple_polys("ntt512_ct_std2rev", ntt512_ct_std2rev, ntt512_omega, true);
  test_simple_polys("ntt512_gs_std2rev", ntt512_gs_std2rev, ntt512_omega, true);

  test_simple_polys("intt512_ct_rev2std", intt512_ct_rev2std, ntt512_inv_omega, false);
  test_simple_polys("intt512_gs_rev2std", intt512_gs_rev2std, ntt512_inv_omega, false);
  test_simple_polys("intt512_ct_std2rev", intt512_ct_std2rev, ntt512_inv_omega, true);
  test_simple_polys("intt512_gs_std2rev", intt512_gs_std2rev, ntt512_inv_omega, true);

  test_forward_inverse("ntt512_ct_std2rev", "intt512_ct_rev2std", ntt512_ct_std2rev, intt512_ct_rev2std);
  test_forward_inverse("intt512_ct_rev2std", "ntt512_ct_std2rev", intt512_ct_rev2std, ntt512_ct_std2rev);
  test_forward_inverse("ntt512_ct_std2rev", "intt512_gs_rev2std", ntt512_ct_std2rev, intt512_gs_rev2std);
  test_forward_inverse("intt512_gs_rev2std", "ntt512_ct_std2rev", intt512_gs_rev2std, ntt512_ct_std2rev);
  test_forward_inverse("ntt512_gs_std2rev", "intt512_gs_rev2std", ntt512_gs_std2rev, intt512_gs_rev2std);
  test_forward_inverse("intt512_gs_rev2std", "ntt512_gs_std2rev", intt512_gs_rev2std, ntt512_gs_std2rev);

  test_simple_products("ntt512_product1", ntt512_product1);
  test_simple_products("ntt512_product2", ntt512_product2);
  test_simple_products("ntt512_product3", ntt512_product3);
  test_simple_products("ntt512_product4", ntt512_product4);
  test_simple_products("ntt512_product5", ntt512_product5);
  
  speed_test("ntt512_ct_rev2std", ntt512_ct_rev2std);
  speed_test("ntt512_gs_rev2std", ntt512_gs_rev2std);
  speed_test("ntt512_ct_std2rev", ntt512_ct_std2rev);
  speed_test("ntt512_gs_std2rev", ntt512_gs_std2rev);
  printf("\n");
  speed_test("intt512_ct_rev2std", intt512_ct_rev2std);
  speed_test("intt512_gs_rev2std", intt512_gs_rev2std);
  speed_test("intt512_ct_std2rev", intt512_ct_std2rev);
  speed_test("intt512_gs_std2rev", intt512_gs_std2rev);
  printf("\n");

  speed_test2("ntt512_product1", ntt512_product1);
  speed_test2("ntt512_product2", ntt512_product2);
  speed_test2("ntt512_product3", ntt512_product3);
  speed_test2("ntt512_product4", ntt512_product4);
  speed_test2("ntt512_product5", ntt512_product5);
