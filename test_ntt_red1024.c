...
int main(void) {
  test_simple_polys("ntt_red1024_ct_rev2std", ntt_red1024_ct_rev2std, ntt_red1024_omega, false);
  test_simple_polys("ntt_red1024_gs_rev2std", ntt_red1024_gs_rev2std, ntt_red1024_omega, false);
  test_simple_polys("ntt_red1024_ct_std2rev", ntt_red1024_ct_std2rev, ntt_red1024_omega, true);
  test_simple_polys("ntt_red1024_gs_std2rev", ntt_red1024_gs_std2rev, ntt_red1024_omega, true);

  test_simple_polys("intt_red1024_ct_rev2std", intt_red1024_ct_rev2std, ntt_red1024_inv_omega, false);
  test_simple_polys("intt_red1024_gs_rev2std", intt_red1024_gs_rev2std, ntt_red1024_inv_omega, false);
  test_simple_polys("intt_red1024_ct_std2rev", intt_red1024_ct_std2rev, ntt_red1024_inv_omega, true);
  test_simple_polys("intt_red1024_gs_std2rev", intt_red1024_gs_std2rev, ntt_red1024_inv_omega, true);

  test_forward_inverse("ntt_red1024_ct_std2rev", "intt_red1024_ct_rev2std", ntt_red1024_ct_std2rev, intt_red1024_ct_rev2std);
  test_forward_inverse("intt_red1024_ct_rev2std", "ntt_red1024_ct_std2rev", intt_red1024_ct_rev2std, ntt_red1024_ct_std2rev);
  test_forward_inverse("ntt_red1024_ct_std2rev", "intt_red1024_gs_rev2std", ntt_red1024_ct_std2rev, intt_red1024_gs_rev2std);
  test_forward_inverse("intt_red1024_gs_rev2std", "ntt_red1024_ct_std2rev", intt_red1024_gs_rev2std, ntt_red1024_ct_std2rev);
  test_forward_inverse("ntt_red1024_gs_std2rev", "intt_red1024_gs_rev2std", ntt_red1024_gs_std2rev, intt_red1024_gs_rev2std);
  test_forward_inverse("intt_red1024_gs_rev2std", "ntt_red1024_gs_std2rev", intt_red1024_gs_rev2std, ntt_red1024_gs_std2rev);

  test_simple_products("ntt_red1024_product1", ntt_red1024_product1);
  test_simple_products("ntt_red1024_product2", ntt_red1024_product2);
  test_simple_products("ntt_red1024_product3", ntt_red1024_product3);
  test_simple_products("ntt_red1024_product4", ntt_red1024_product4);
  test_simple_products("ntt_red1024_product5", ntt_red1024_product5);

  speed_test("ntt_red1024_ct_rev2std", ntt_red1024_ct_rev2std);
  speed_test("ntt_red1024_gs_rev2std", ntt_red1024_gs_rev2std);
  speed_test("ntt_red1024_ct_std2rev", ntt_red1024_ct_std2rev);
  speed_test("ntt_red1024_gs_std2rev", ntt_red1024_gs_std2rev);
  printf("\n");
  speed_test("intt_red1024_ct_rev2std", intt_red1024_ct_rev2std);
  speed_test("intt_red1024_gs_rev2std", intt_red1024_gs_rev2std);
  speed_test("intt_red1024_ct_std2rev", intt_red1024_ct_std2rev);
  speed_test("intt_red1024_gs_std2rev", intt_red1024_gs_std2rev);
  printf("\n");

  speed_test2("ntt_red1024_product1", ntt_red1024_product1);
  speed_test2("ntt_red1024_product2", ntt_red1024_product2);
  speed_test2("ntt_red1024_product3", ntt_red1024_product3);
  speed_test2("ntt_red1024_product4", ntt_red1024_product4);
  speed_test2("ntt_red1024_product5", ntt_red1024_product5);
