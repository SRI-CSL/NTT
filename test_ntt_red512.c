...
int main(void) {
  test_simple_polys("ntt_red512_ct_rev2std", ntt_red512_ct_rev2std, ntt_red512_omega, false);
  test_simple_polys("ntt_red512_gs_rev2std", ntt_red512_gs_rev2std, ntt_red512_omega, false);
  test_simple_polys("ntt_red512_ct_std2rev", ntt_red512_ct_std2rev, ntt_red512_omega, true);
  test_simple_polys("ntt_red512_gs_std2rev", ntt_red512_gs_std2rev, ntt_red512_omega, true);

  test_simple_polys("intt_red512_ct_rev2std", intt_red512_ct_rev2std, ntt_red512_inv_omega, false);
  test_simple_polys("intt_red512_gs_rev2std", intt_red512_gs_rev2std, ntt_red512_inv_omega, false);
  test_simple_polys("intt_red512_ct_std2rev", intt_red512_ct_std2rev, ntt_red512_inv_omega, true);
  test_simple_polys("intt_red512_gs_std2rev", intt_red512_gs_std2rev, ntt_red512_inv_omega, true);

  test_forward_inverse("ntt_red512_ct_std2rev", "intt_red512_ct_rev2std", ntt_red512_ct_std2rev, intt_red512_ct_rev2std);
  test_forward_inverse("intt_red512_ct_rev2std", "ntt_red512_ct_std2rev", intt_red512_ct_rev2std, ntt_red512_ct_std2rev);
  test_forward_inverse("ntt_red512_ct_std2rev", "intt_red512_gs_rev2std", ntt_red512_ct_std2rev, intt_red512_gs_rev2std);
  test_forward_inverse("intt_red512_gs_rev2std", "ntt_red512_ct_std2rev", intt_red512_gs_rev2std, ntt_red512_ct_std2rev);
  test_forward_inverse("ntt_red512_gs_std2rev", "intt_red512_gs_rev2std", ntt_red512_gs_std2rev, intt_red512_gs_rev2std);
  test_forward_inverse("intt_red512_gs_rev2std", "ntt_red512_gs_std2rev", intt_red512_gs_rev2std, ntt_red512_gs_std2rev);

  test_simple_products("ntt_red512_product1", ntt_red512_product1);
  test_simple_products("ntt_red512_product2", ntt_red512_product2);
  test_simple_products("ntt_red512_product3", ntt_red512_product3);
  test_simple_products("ntt_red512_product4", ntt_red512_product4);
  test_simple_products("ntt_red512_product5", ntt_red512_product5);

  speed_test("ntt_red512_ct_rev2std", ntt_red512_ct_rev2std);
  speed_test("ntt_red512_gs_rev2std", ntt_red512_gs_rev2std);
  speed_test("ntt_red512_ct_std2rev", ntt_red512_ct_std2rev);
  speed_test("ntt_red512_gs_std2rev", ntt_red512_gs_std2rev);
  printf("\n");
  speed_test("intt_red512_ct_rev2std", intt_red512_ct_rev2std);
  speed_test("intt_red512_gs_rev2std", intt_red512_gs_rev2std);
  speed_test("intt_red512_ct_std2rev", intt_red512_ct_std2rev);
  speed_test("intt_red512_gs_std2rev", intt_red512_gs_std2rev);
  printf("\n");

  speed_test2("ntt_red512_product1", ntt_red512_product1);
  speed_test2("ntt_red512_product2", ntt_red512_product2);
  speed_test2("ntt_red512_product3", ntt_red512_product3);
  speed_test2("ntt_red512_product4", ntt_red512_product4);
  speed_test2("ntt_red512_product5", ntt_red512_product5);
